...
class DiscoveryHistoryService extends ChangeNotifier {
  ...
  static final DiscoveryHistoryService _instance = DiscoveryHistoryService._privateConstructor();
  DiscoveryHistoryService._privateConstructor();

  factory DiscoveryHistoryService() {
    return _instance;
  }
